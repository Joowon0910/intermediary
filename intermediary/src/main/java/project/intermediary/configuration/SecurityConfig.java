...
import project.intermediary.jwt.JwtAccessDeniedHandler;
import project.intermediary.jwt.JwtAuthenticationEntryPoint;
import project.intermediary.jwt.JwtSecurityConfig;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  public void configure(WebSecurity web) {
    web
      .ignoring()
      .antMatchers("/h2-console/**", "/favicon.ico", "/error", "/", "/page/**");
  }
  ...
  protected void configure(HttpSecurity httpSecurity) throws Exception {
    httpSecurity
      ...
      .and()
      .authorizeRequests() //HttpServletRequest를 사용하는 요청들에 대해 접근제한을 설정
      ...
      .permitAll()
      .anyRequest()
      .authenticated() //나머지 요청들에 대해서는 인증을 받아야함
